...
import com.estrumetal.jpacontroller.MateriaPrimaFacade;
...
@ManagedBean(name = "materiaPrimaController")
@SessionScoped
public class MateriaPrimaController implements Serializable {
    ...
    @EJB
    private com.estrumetal.jpacontroller.MateriaPrimaFacade ejbFacade;
    ...
    public String create() {
        if (current.getPesoMl().compareTo(BigDecimal.ZERO) <= 0) {
            JsfUtil.addErrorMessage("El peso metro lineal debe ser mayor a '0'.");
            return null;
        } else {
            try {
                getFacade().create(current);
                JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MateriaPrimaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MateriaPrimaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MateriaPrimaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
