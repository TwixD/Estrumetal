...
@ManagedBean(name = "maquinaController")
@SessionScoped
public class MaquinaController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("MaquinaCreated"));
    ...
    public static class MaquinaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            MaquinaController controller = (MaquinaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "maquinaController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Maquina) {
                Maquina o = (Maquina) object;
                return getStringKey(o.getIdMaquina());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Maquina.class.getName());
            }
        }
