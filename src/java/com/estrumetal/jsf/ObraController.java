...
import com.estrumetal.jpacontroller.ObraFacade;
...
public class ObraController implements Serializable {
    ...
    @EJB
    private com.estrumetal.jpacontroller.ObraFacade ejbFacade;
    ...
    public static class ObraControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Obra) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Obra.class.getName());
            }
        }
